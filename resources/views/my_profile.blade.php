            ...
            <form class="row  shadow-sm p-3  bg-white rounded" method="POST" action="{{ route('myaccountUpdate') }}" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="phone" type="text" id="account-phone" placeholder="+7 (805) 348 95 72"  value="{{ Auth::user()->phone }}" >
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="pfilehidden" type="hidden" id="account-pass" value="{{ Auth::user()->profile_photo_path }}">
                    </div>
                </div>
                <div class="col-12">
                    <hr class="mt-2 mb-3">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        <button class="custom-button" type="submit" style="background: #BC873C !important;">Update Profile</button>
                    </div>
                </div>
            </form>
        </div>
