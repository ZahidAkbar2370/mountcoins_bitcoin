...
<label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color: cadetblue">Step 1</label></i><br>
<strong>How to Sell</strong><br>
<span style="color: black">Select Coin > Enter the amount you want to sell > Select Currency > Select Payment Method
</span></div>
 </div> 
...
<label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color: cadetblue">Step 2</label></i><br>
<strong>Payment Details</strong><br>
<span style="color: black">Fill out your payment details for immediate payment</span>
</div>
 </div> 
...
<label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color: cadetblue">Step 3</label></i><br>
<strong>Wallet Address</strong><br>
<span style="color: black">Copy our Wallet Address or scan our QR Code for payment</span>
</div>
 </div> 
...
<label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color: cadetblue">Step 4</label></i><br>
<strong>Make Payment</strong><br>
<span style="color: black">Send the bitcoin amount you want to sell from your Wallet to our Wallet Address or QR Code</span>
</div>
 </div> 
 <div class="col-md-2">
<div class=" p-1 " style="color:#BC873C;">

<label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color: cadetblue">Step 5</label></i><br>
<strong>Payment SS</strong><br>Upload <span style="color: black">payment screenshot from the confirmation page provided by your bitcoin wallet</span>
</div>
 </div> 
        ...
        <div class="row classrowpaddincustom" style="margin-top: 5px;margin-bottom:20px;">
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="input-group mb-3">
                    ...
                    <button type="submit" class="btn btn-primary mb-5 font-weight-bold" style="width:250px;background-color:#BC873C;border:1px solid #BC873C;height: 60px;border-radius: 27px;">Sell Now</button>
