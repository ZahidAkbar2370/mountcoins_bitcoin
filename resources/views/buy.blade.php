...
<form action="{{ route('make_order_buy') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">

    @csrf 
<input type="hidden" name="hiddenbtcbuyPrice" class="hiddenbtcbuyPrice" value="{{CH::Get_Buy_Setting_price()}} ">
...
<div class="col-md-2">
    ...
    <label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color:cadetblue;text-align: justify;">Step 1</label><i class="right"></i><br>
    <strong>How to Buy</strong><br>
    <span style="color: black">Enter the amount you want to buy > select coin > select currency > select payment method</span>
    </div>
 </div> 
...
<div class="col-md-2">
    ...
    <label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color:cadetblue">Step 2</label><br>
    <strong>Make Payment</strong><br>
    <span style="color: black">Make a bank transfer or cash deposit to our provided bank account</span>
    </div>
 </div>
...
<div class="col-md-2">
    ...
    <label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color:cadetblue">Step 3</label><br>
    <strong>Wallet Address</strong><br>
    <span style="color: black">Provide your Wallet Address to receive BTC</span>
    </div>
 </div> 
...
<div class="col-md-2">
    ...
    <label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color:cadetblue">Step 4</label><br>
    <strong>Payment SS</strong><br>
    <span style="color: black">Upload bank transfer or cash deposit payment screenshot for confirmation<span style="color: black">
    </div>
 </div> 
 ...
 <div class="col-md-2">
    ...
    <label class="rounded-circle shadow-lg px-3 py-4 text-white" style="border: 2px solid cadetblue;background-color:cadetblue">Step 5</label><br>
    <strong>Receive BTC</strong><br><span style="color: black">You will receive BTC as soon as your payment has been confirmed</span>
    </div>
     </div> 
</div>
<div class="col-md-1"></div>
    <input type="hidden" name="percentagecut" class="percentagecut">
     <input type="hidden" name="BtcValLatest" class="BtcValLatest">
   
   <input type="hidden" name="Origenalorder" class="Origenalorder">

      <h2 class="text-center my-2 bg font-weight-bolder" style="color: #BC873C;">Buy Cryptocurrency Coins</h2>
        <div class="row" style="margin-top: 20px;">     
            ...
            <label class="text-white" style="width: 100%;">Enter Amount in Select Currency: </label>
            ...
            <input type="number" name="bitcoin_entered_amount"  id="bitcoin_value" class="form-control bitcoin_valuefConverion" min="0" value="1" style="background-color:#e9ecef;margin-bottom:20px" step="any">
                    ...
                    <label class="text-white" style="width:100%;">Select Cryptocurrency Coin Want To Buy:</label>
                    ...
                    <select   id="bitcoin_value" class="cointType" name="coniType" style="background-color:#e9ecef;width:100% !important;margin-bottom: 20px">
                         ...
                         <option value="select_currency">Select Cryptocurrency Coin</option>
                        @foreach ($View_Bit_Cry_Prices as  $Prices)
                        ...
                        <label class="text-white select_currency_to" style="width:100%;">Cryptocurrency Coin Amount:(e.g 500 USD Equal To 0.01461115 BTC)</label>

                      <input type="number" name="bitcoin_converted_amount"  id="bitcoin_value" class="form-control bitcoin_converted_amount select_currency select_currency_to" readonly="" required>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="westrenunion_full_name"  placeholder="Full Name" id="account_id" class="westren_union" style="width: 100% !important;margin-bottom:20px" required>
                      ...
                      <input type="text" name="bTransfer_bank_name"  placeholder="First National Bank" id="account_id" class="bTransfer" style="width: 100% !important;margin-bottom:20px" required>
                        ...
                        <input type="text" name="cashDeposit_bank_name"  placeholder="First National Bank" id="account_id" class="cashDeposit" style="width: 100% !important;margin-bottom:20px" required>
                    ...
                    <button type="submit" class="btn btn-primary mb-5 font-weight-bold" style="width:250px;background-color:#BC873C;border:1px solid #BC873C;height: 60px;border-radius: 27px;">Buy Now</button>
      ...
      <div class="col-12">
        <strong class="text-success">
         Price $ @php
              ...
              $btcvalplus= $Prices->price+ CH::Get_Latest_Additional_price()->cryptocurrency_additional_buy_price;
  

           $btcvalTotal=$btcvalplus-CH::Get_Latest_Additional_price()->cryptocurrency_decremental_buy_price; 
             echo $btcvalTotal;
...
var hiddenbtcsellPrice=$('.hiddenbtcbuyPrice').val();
   $('.coinValassign').addClass('bg-warning');
    $('.coinValassign').text("BUY BTC:$"+hiddenbtcsellPrice);
...
var CointPlusVal= + res.PRICE + +{{CH::Get_Latest_Additional_price()->cryptocurrency_additional_buy_price}};

var converted_amount=CointPlusVal-{{CH::Get_Latest_Additional_price()->cryptocurrency_decremental_buy_price}};

$('.coinValassign').text(`BUY ${coinType}:${converted_amount} ${currencyType}`); 
// console.log('final btc'+converted_amount)
var transactionFee={{CH::Get_Latest_Additional_price()->transaction_fee_buy}};

var percentagecut=coinVal-(coinVal*transactionFee/100);

// console.log("per"+percentagecut);
// console.log('coin'+coinVal);
var Origenalorder=1/converted_amount*coinVal;

var multipyCount=(1/converted_amount)*percentagecut;

    

$('.Origenalorder').val(Origenalorder);        
$('.BtcValLatest').val(converted_amount);
$('.percentagecut').val(percentagecut);
$('.bitcoin_converted_amount').val(multipyCount);
...
let classesCss=['paypal','bank_wire','westren_union','bTransfer','cashDeposit','perfect_money','payza','payoneer','webmoney','okpay','skrill','nettler','dash','money_gram','credit_card','instaforex','solid_trust_pay','us_bank','advcash','alipay_china','paysafecard','onecard','sofort','qivi_wallet','entromoney','mobile_wallet','mobile_pay','capital_one','apple_pay','chase_quick_pay','transfer_wise','venmo_mobile_payment','chase_quick_pay','swift_transfer','direct_bank_deposit','buy_gift_card','buy_virtual_card','google_pay','yandex_money','payco','ria_money_transfer','xoom_money_transfer','wordremit'];
