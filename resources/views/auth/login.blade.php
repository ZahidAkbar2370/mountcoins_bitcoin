...
@endif
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <a href="{{url('register')}}" class="btn-outline-primary  btn-lg text-white font-weight-bold shadow-lg text-decoration-none" style="background-color:#BC873C!important;
                                border: 1px solid #BC873C;
                                ">
                                 {{ __('Register') }}
                                </a>
